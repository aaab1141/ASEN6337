...
imds = imageDatastore([folder,'\trainingset9'],'IncludeSubfolders',true,'FileExtensions','.png','LabelSource','foldernames');
...
save([folder,'\trainedNets\resnet50_set4p2.mat'],'trainednet','imdsvalidation')

figure
plotconfusion(imdsvalidation.Labels,YPred);
title('Boosted 80/20 6 Epochs')
ax = gca;
ax.YTickLabel = ticks;
ax.XTickLabel = ticks;
