% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This is the training script for resent50 using training set 8.
% 
% Written 2019-12-10 | Aaron Aboaf
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
clear

ticks = [{'Concrete/Cement'};{'Incomplete'};{'Metal'};{'Other Material'};{''}];
folder = cd;
...
imds = imageDatastore([folder,'\trainingset8'],'IncludeSubfolders',true,'FileExtensions','.png','LabelSource','foldernames');
...
save([folder,'\trainedNets\resnet50_set8.mat'],'trainednet','imdsvalidation')

figure
plotconfusion(imdsvalidation.Labels,YPred);
title('Four Class Training')
ax = gca;
ax.YTickLabel = ticks;
ax.XTickLabel = ticks;
