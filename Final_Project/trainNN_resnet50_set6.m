% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This is the training script for resent50 using training set 6.
% 
...
imds = imageDatastore([folder,'\trainingset6'],'IncludeSubfolders',true,'FileExtensions','.png','LabelSource','foldernames');
...
save([folder,'\trainedNets\resnet50_set6.mat'],'trainednet','imdsvalidation')

figure
plotconfusion(imdsvalidation.Labels,YPred);
title('Confusion Matrix: resnet50 Training Set 6')
