% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This script analyzes the statistics of all the cloud data that is
% processed using the imageprocesssing.m script. It assumes the same folder
% structure that is generated using imageprocessing.m
% 
% Written 2019-11-25 | Aaron Aboaf
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
clear
close all
...
% Fish Statistics
fishdirectoryinfo = dir([folder,'\fishclouds']);
...
% Flower Statistics
flowerdirectoryinfo = dir([folder,'\flowerclouds']);
...
% Gravel Statistics
graveldirectoryinfo = dir([folder,'\gravelclouds']);
...
% Sugar Statistics
sugardirectoryinfo = dir([folder,'\sugarclouds']);
...
hold off
save_fig_png('Average Histogram Comparison')
...
legend('Fish','Flower','Gravel','Sugar')
hold off
save_fig_png('Standard Deviation Histogram Comparison')
