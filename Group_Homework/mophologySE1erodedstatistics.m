% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This does the statistics on the Modphology SE1 eroded images to see if they are better
...
folder = cd;
secondpath = '\reducedimages\morphologySE1\eroded';
...
hold off
save_fig_png('SE1 Eroded Images Average Histogram Comparison')
...
legend('Fish','Flower','Gravel','Sugar')
hold off
save_fig_png('SE1 Eroded Images Standard Deviation Histogram Comparison')
