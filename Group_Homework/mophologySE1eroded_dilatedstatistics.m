% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This does the statistics on the Modphology SE1 eroded the SE1 dilated images to see if they are better
...
folder = cd;
secondpath = '\reducedimages\morphologySE1\eroded_dilated';
...
hold off
save_fig_png('SE1 Eroded Dilated Images Average Histogram Comparison')
...
legend('Fish','Flower','Gravel','Sugar')
hold off
save_fig_png('SE1 Eroded Dilated Images Standard Deviation Histogram Comparison')
