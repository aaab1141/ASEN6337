% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This does the statistics on the Modphology SE3 eroded the SE3 dilated images to see if they are better
...
folder = cd;
secondpath = '\reducedimages\morphologySE3\eroded_dilated';
...
hold off
save_fig_png('SE3 Eroded Dilated Images Average Histogram Comparison')
...
legend('Fish','Flower','Gravel','Sugar')
hold off
save_fig_png('SE3 Eroded Dilated Images Standard Deviation Histogram Comparison')
