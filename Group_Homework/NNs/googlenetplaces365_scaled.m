% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This is the script that changes the googlenet places365 network to work with the
...
save('GooglenetPlaces365_Scaled_trainednet.mat','trainednet')
...
title('Confusion Matrix: GoogLeNet Places365 Scaled Square Images')