% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This is the script that changes the mobilenetv2 network to work with the
...
save('Mobilenetv2_Scaled_trainednet.mat','trainednet')
...
title('Confusion Matrix: mobilenetv2 Scaled Square Images')