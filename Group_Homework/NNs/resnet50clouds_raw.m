...
% that wee humans can understand them.
% 
% Written 2019-12-01 | Aaron Aboaf
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
clear

% unzip('Raw_training.zip');
imds = imageDatastore('Resnet50\Raw','IncludeSubfolders',true,'LabelSource','foldernames');
...
save('resnet50_raw_trainednet.mat','trainednet')
...
title('Confusion Matrix: resnet50 Raw Square Images')