% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This does the statistics on the binary images to see if they are better
...
folder = cd;
secondpath = '\reducedimages\binary';
...
hold off
save_fig_png('Binary Images Average Histogram Comparison')
...
legend('Fish','Flower','Gravel','Sugar')
hold off
save_fig_png('Binary Images Standard Deviation Histogram Comparison')
